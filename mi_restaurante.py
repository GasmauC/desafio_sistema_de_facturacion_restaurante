...
def total():
    ...
    for cantidad in texto_comida:
        ...
        valor = cantidad.get()
        # Si está vacío, lo convertimos a 0, si no, a float
...
def recibo():
    ...
    texto_recibo.insert(END, f' Costo de la Bebdia: \t\t\t{var_costo_bebida.get()}\n')
...
# panel izquierdo
panel_izquiero = Frame(aplicacion,bd=1,relief=FLAT,bg='burlywood')
...
lista_bebidas = ['Gaseosas','soda','agua mineral','vino tinto','vino blanco','juego','cerveza','licuados']
lista_postres = ['helado','ensalada de fruta','flan','budin','tiramisu','torta','brownies','mouse']
